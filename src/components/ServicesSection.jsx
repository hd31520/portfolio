...
const ServicesSection = ({ id }) => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Optimized for all screen sizes including phones and tablets.",
    },
    {
    ...
    },
    {
      ...
      description: "Deployed with HTTPS, JWT auth, and services like Firebase or Vercel.",
    },
    {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className={`mb-12 p-4 rounded-lg text-center ${
          theme === 'dark' 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className={`transition duration-300 shadow-lg rounded-2xl p-6 ${
                theme === 'dark' 
                  ? 'bg-gray-800 hover:bg-gray-700' 
                  : 'bg-white hover:bg-gray-100'
              }`}
            >
              <div className={`p-3 rounded-full inline-flex items-center justify-center mb-4 ${
